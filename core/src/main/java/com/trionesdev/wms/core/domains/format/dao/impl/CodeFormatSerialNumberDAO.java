...
import com.trionesdev.wms.core.domains.format.dao.mapper.CodeFormatSerialNumberMapper;
...
public class CodeFormatSerialNumberDAO extends ServiceImpl<CodeFormatSerialNumberMapper, CodeFormatSerialNumberPO> {
    ...
    public CodeFormatSerialNumberPO selectByTimeIdentifier(String identifier, String timeIdentifier) {
        return lambdaQuery()
    ...
    public void updateByTimeIdentifier(CodeFormatSerialNumberPO po) {
