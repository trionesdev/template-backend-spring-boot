...
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = BossFunctionalResourcePO.TABLE_NAME)
public class BossFunctionalResourcePO extends BasePO {
    public static final String TABLE_NAME = "triones_boss_perm_functional_resource";
