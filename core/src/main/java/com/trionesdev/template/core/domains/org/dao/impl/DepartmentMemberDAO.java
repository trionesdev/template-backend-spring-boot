package com.trionesdev.template.core.domains.org.dao.impl;
...
import com.trionesdev.template.core.domains.org.dao.mapper.DepartmentMemberMapper;
    ...
    private LambdaQueryWrapper<DepartmentMemberPO> buildQueryWrapper(DepartmentMemberCriteria criteria) {
        ...
        if (Objects.nonNull(criteria)) {
            queryWrapper.eq(StrUtil.isNotBlank(criteria.getDepartmentId()), DepartmentMemberPO::getDepartmentId, criteria.getDepartmentId())
                    .eq(StrUtil.isNotBlank(criteria.getUserId()), DepartmentMemberPO::getMemberId, criteria.getUserId());
        }
        return queryWrapper;
    }
