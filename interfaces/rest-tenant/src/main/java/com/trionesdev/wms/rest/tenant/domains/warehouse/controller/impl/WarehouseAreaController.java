...
public class WarehouseAreaController {
    ...
    public void createWarehouse(@Validated @RequestBody WarehouseAreaRO args) {
    ...
    public WarehouseAreaDTO queryWarehouseById(@PathVariable String id) {
        return warehouseAreaService.findById(id).orElse(null);
    }

    @Operation(summary = "查询库区列表分页")
    @GetMapping("warehouse-areas/page")
    public PageInfo<WarehouseAreaDTO> queryWarehousePage(
    ...
    public List<WarehouseAreaDTO> queryWarehouseList(WarehouseAreaQueryRO query) {
        var criteria = convert.from(query);
    ...
    public void deleteWarehouseByIds(@PathVariable(value = "ids") List<String> ids) {
