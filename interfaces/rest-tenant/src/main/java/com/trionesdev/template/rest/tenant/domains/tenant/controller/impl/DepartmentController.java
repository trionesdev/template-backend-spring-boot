package com.trionesdev.template.rest.tenant.domains.tenant.controller.impl;

import cn.hutool.core.lang.tree.Tree;
import cn.hutool.core.util.EnumUtil;
import com.trionesdev.commons.core.page.PageInfo;
import com.trionesdev.template.core.domains.tenant.dto.DepartmentDTO;
import com.trionesdev.template.core.domains.tenant.dto.DepartmentMemberDTO;
import com.trionesdev.template.core.domains.tenant.dto.cmd.DepartmentTreeQuery;
import com.trionesdev.template.core.domains.tenant.dto.OrgNodeDTO;
...
import com.trionesdev.template.rest.tenant.domains.tenant.controller.ro.department.DepartmentOrgNodesQueryRO;
import com.trionesdev.template.rest.tenant.domains.tenant.controller.ro.department.DepartmentUpdateRO;
import com.trionesdev.template.rest.tenant.domains.tenant.internal.OrgBeRestConvert;
import com.trionesdev.template.rest.tenant.domains.tenant.internal.OrgRestConstants;
...
public class DepartmentController {
    ...
    public List<OrgNodeDTO> queryDepartmentOrgList(DepartmentOrgNodesQueryRO query) {
        return departmentService.findDepartmentOrgNodes(OrgNodeQuery.builder().departmentId(query.getDepartmentId()).type(query.getType()).build());
    }
