...
import com.trionesdev.mes.domain.core.domains.tenant.repository.mapper.TenantMemberMapper;
...
@Repository
public class TenantMemberRepository extends ServiceImpl<TenantMemberMapper, TenantMemberPO> {
